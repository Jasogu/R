...
![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/visualization-1.png)<!-- -->![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/visualization-2.png)<!-- -->

<br><br>

### 남성과 여성, 나이와 임금의 관계

![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-1-2.png)<!-- -->
...
![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-3-2.png)<!-- -->
...
![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->![](통계청-자료를-통해-알아보는-한국의-임금결정-모델-분석_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
